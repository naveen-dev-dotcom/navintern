    ...
    if (selectedPlan) {
      ...
      const submitData = async () => {
        try {
          ...
          alert("Error: Failed to submit data. Please check your network or try again.");
        }
      };
      ...
      <div className="d-flex flex-column position-fixed top-0 w-100">
        <nav className="navbar navbar-expand-lg" style={{ backgroundColor: "#B5CFFF" }}>
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse d-flex justify-content-end" id="navbar-text">
        ...
        <div style={{ backgroundColor: "#f6f9ff", minHeight: "100vh" }}>
          <div className="container py-5">
            <div className="text-center mb-4">
              <h4 style={{ color: "#012970", fontSize: "20px", textDecoration: "underline" }}>
                Select Your Plan
              </h4>
              <p className="text-muted">
                "From active listening to strategic implementation, we redefine systems for enhanced efficiency, simplified processes, and informed decision-making."
              </p>
            </div>
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-md-4">
                <div className="card shadow">
                  ...
                  <div className="card-body text-left">
                    <p className="text-muted">
                      <span style={{ color: "#012970", fontSize: "20px", fontWeight: "500" }}>Expires in</span> 24 hours
                    </p>
                    ...
                    <button onClick={() => handlePlanSelection("free")} className="btn btn-outline-primary w-100 mt-3 mb-2">
                      Create Free Account
                    </button>
                  </div>
                </div>
              ...
              <div className="col-md-4">
                <div className="card shadow">
                  ...
                  <div className="card-body text-left">
                    <p className="text-muted">
                      <span style={{ color: "#012970", fontSize: "20px", fontWeight: "500" }}>Rs 999</span>/week
                    </p>
                    <ul className="list-unstyled">
                      <li style={listStyle}>Max file size: 5 MB</li>
                      <li style={listStyle}>OCR support: YES</li>
                    ...
                    <button onClick={() => handlePlanSelection("silver")} className="btn btn-outline-primary w-100 mt-3 mb-2">
                      Select Plan
                    </button>
                  </div>
                </div>
              ...
              <div className="col-md-4">
                <div className="card shadow">
                  ...
                  <div className="card-body text-left">
                    <p className="text-muted">
                      <span style={{ color: "#012970", fontSize: "20px", fontWeight: "500" }}>Rs 3499</span>/mo
                    </p>
                    <ul className="list-unstyled">
                      <li style={listStyle}>Max file size: 5 MB</li>
                      <li style={listStyle}>OCR support: YES</li>
                    ...
                    <button onClick={() => handlePlanSelection("gold")} className="btn btn-outline-primary w-100 mt-3 mb-2">
                      Select Plan
                    </button>
                  </div>
                </div>
