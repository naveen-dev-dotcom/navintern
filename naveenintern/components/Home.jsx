                ...
                <div className="container text-center mt-5" >
                    <div className="row">
                        ...
                        <div className="col-12 mt-4 ">
                            <button type="submit" className="btn me-4 rounded-pill border border-primary"
  style={{ color: '#012970', backgroundColor: '#B5CFFF' }} onClick={handleLoginBtn}>Login</button>
                            <button type="submit"className="btn me-4 rounded-pill border border-primary"
  style={{ color: '#012970', backgroundColor: '#B5CFFF' }}onClick={handleRegisterBtn}>Register Now</button>
                        </div>
                    </div>
                </div>  
              </div>    
